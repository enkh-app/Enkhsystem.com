...
const styles=StyleSheet.create({page:{flex:1,backgroundColor:'#F7F7F5'},content:{width:'100%',maxWidth:920,alignSelf:'center',paddingHorizontal:20,paddingTop:42,paddingBottom:56},heading:{maxWidth:720},title:{fontSize:38,lineHeight:46,fontWeight:'900',color:'#171717'},subtitle:{marginTop:12,fontSize:16,lineHeight:24,color:'#6B6B6B'},warning:{marginTop:16,padding:10,borderRadius:10,backgroundColor:'#FFF4E3',color:'#6F4A13',fontSize:12},searchBox:{marginTop:28,flexDirection:'row',alignItems:'center',gap:8,padding:8,borderRadius:20,backgroundColor:'#FFF',borderWidth:1,borderColor:'#DDD'},input:{flex:1,minHeight:48,paddingHorizontal:13,fontSize:16,color:'#171717'},button:{minHeight:48,justifyContent:'center',paddingHorizontal:22,borderRadius:14,backgroundColor:'#171717'},buttonText:{color:'#FFF',fontWeight:'800'},disabled:{opacity:.3},pressed:{opacity:.7},state:{flexDirection:'row',alignItems:'center',gap:12,paddingVertical:44,justifyContent:'center'},stateText:{color:'#686868'},error:{marginTop:24,padding:20,borderRadius:18,backgroundColor:'#FFF4F2',borderWidth:1,borderColor:'#F1C9C1'},errorTitle:{fontSize:16,fontWeight:'800',color:'#8B2C20'},errorText:{marginTop:6,fontSize:14,lineHeight:21,color:'#744139'},results:{marginTop:28,gap:12},answerCard:{padding:24,borderRadius:20,backgroundColor:'#FFF',borderWidth:1,borderColor:'#E1E1DD'},label:{fontSize:11,letterSpacing:1.8,fontWeight:'900',color:'#777'},answer:{marginTop:14,fontSize:16,lineHeight:26,color:'#202020'},sourcesTitle:{marginTop:18,fontSize:20,fontWeight:'900',color:'#171717'},source:{minHeight:76,flexDirection:'row',alignItems:'center',padding:16,borderRadius:16,backgroundColor:'#FFF',borderWidth:1,borderColor:'#E1E1DD'},sourceText:{flex:1},sourceTitle:{fontSize:15,lineHeight:21,fontWeight:'700',color:'#202020'},sourceUrl:{marginTop:4,fontSize:12,color:'#777'},arrow:{marginLeft:12,fontSize:20,color:'#555'},noSources:{color:'#777',fontSize:14}});
